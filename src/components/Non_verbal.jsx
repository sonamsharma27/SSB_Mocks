...
import Questions from './Non_ques_ver'
import { moveNextQuestion } from '../hooks/NonFetchQuestion'
import { movePrevQuestion } from '../hooks/NonFetchQuestion'
...
export default function Non_verbal() {
  ...
  return (
    ...
    <div className='cont'>
      ...
      <div>
      <h1 className='oir-head'>OIR Non Verbal Reasoning: Mock Test</h1>
