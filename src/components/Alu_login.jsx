...
export default function Alu_login({setLoginUser}) {
  ...
  const login = () => {
    axios.post("http://localhost:5000/alu_login", user)
    .then(res => {
    ...
    return (
      ...
      <Form action="POST">
        ...
        <p  className='para2'>Not Registered 
          <NavLink to="/alu_signup" className='s_signup'>Registered</NavLink>
        </p>
      </Form>
      </div>
      </div>
